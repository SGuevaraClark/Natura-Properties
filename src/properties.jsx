...
// You can keep the image imports for now as fallbacks
...
// Create a function to fetch properties from PocketBase
export const getProperties = async () => {
  try {
    ...
    // Return default properties as fallback
    return defaultProperties;
  }
};

// Keep your default properties as fallback
